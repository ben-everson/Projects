...
%nonassoc GOESTO                  /* function declaration, with clause */
%nonassoc IN
...
expr:
  ...
  | LET; REC; x = IDENT; EQUALS; e1 = expr; IN; e2 = expr { Let(x,true, e1,e2) }
	| LET; x = IDENT; EQUALS; e1 = expr; IN; e2 = expr { Let(x,false,e1,e2) }
  | FUN; x = IDENT; GOESTO; e1=expr { Fun(x, e1) }
